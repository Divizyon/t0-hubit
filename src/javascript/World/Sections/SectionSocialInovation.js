...
const DEFAULT_POSITION = new THREE.Vector3(75, -10, 0);

export default class SectionSocialInovaiton {
  ...
  _buildModel() {
    const gltf = this.resources.items.SocialInovation;
    ...
    baseModel.position.set(75, -10, 0); // Base modelinin Kapsül altına yerleştirilmesi için pozisyon ayarı
