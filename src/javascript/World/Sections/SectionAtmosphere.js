...
export default class SectionAtmosphere {
    ...
    setModel() {
        if (!this.scene) {
            console.warn('SectionAtmosphere: scene parametresi verilmedi, model sahneye eklenmeyecek.');
            return;
        }
        ...
        loader.load('./models/SectionAtmosphere/base.glb', (gltf) => {
            ...
            this.model.position.set(-20, 4, 0);
            ...
            if (this.physics) {
                this.collisionBody = new CANNON.Body({
                    mass: 0,
                    position: new CANNON.Vec3(-6, -28, 1),
